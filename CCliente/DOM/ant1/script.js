...
● O número de ligazóns da páxina. document.getElementsByTagName("a").length+1
● A dirección da penúltima ligazón. document.body.getElementsByTagName("a")[document.body.getElementsByTagName("a").length-2].href 
● O número de ligazóns que apuntan a http://proba 

let url= document.body.getElementsByTagName("a");
let contaURL=0;
for (const object of url) {
if (object.getAttribute("href")=="http://proba") {
    contaURL++;
}

}

console.log(contaURL);
...
document.body.getElementsByTagName("p")[2].getElementsByTagName("a").length+1
